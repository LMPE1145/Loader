...
if LocalPlayer:GetAttribute("LMHUBLoaded") then 
print("LMHUB already loaded")
...
Library:Notify("Loading LMHUB for DOORS",5)
...
LocalPlayer:SetAttribute("LMHUBLoaded",true)
...
LocalPlayer:SetAttribute("LMHUBLoaded",false)
...
game.Players.LocalPlayer:SetAttribute("LMHUBLoaded",true)

local repo = 'https://raw.githubusercontent.com/mstudio45/LinoriaLib/main/'
local Executor = identifyexecutor()  or getexecutorname() 
local Library =  loadstring(game:HttpGet(repo..'Library.lua'))()
Library:Notify("Loading LMHUB for Legends of speed ",5)
task.wait(1.5)
Sound()
...
function Unload()
game.Players.LocalPlayer:SetAttribute("LMHUBLoaded",false)
...
Library:Notify("Loading LMHUB for OP Ninja Simulator ",5)
...
Window = Library:CreateWindow({
    Title = 'LMHUB v4.5 |Op Ninja Simulator.    ',
    Center = true,
    AutoShow = true
})
...
Library:Notify("Loading LMHUB for Murder Mystery 2",5)
